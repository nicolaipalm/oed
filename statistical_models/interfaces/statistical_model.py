...
class StatisticalModel(ABC):
    ...
    def calculate_determinant_fisher_information_matrix(self, x0: np.ndarray, theta: np.ndarray) -> float:
    ...
    def calculate_maximum_likelihood_estimation(self,
        ...
        return minimizer(function=lambda theta: -self.calculate_likelihood(theta=theta, y=y, x0=x0),
