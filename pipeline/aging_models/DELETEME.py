...
from src.statistical_models.statistical_model_library.multiple_dimensional_gaussian_noise_model import \
    MultipleDimensionalGaussianNoiseModel
...
statistical_model = MultipleDimensionalGaussianNoiseModel(
